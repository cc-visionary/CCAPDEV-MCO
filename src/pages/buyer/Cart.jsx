...
const Cart = ({ cart, deleteProductFromCart, deleteProductsFromCart, ...props }) => {
  ...
  const toggleACheckbox = (index, checked) => {
    ...
    if(!curr.includes(true)) setCheckAll(false)
    else if(!curr.includes(false)) setCheckAll(true)

    if(curr.includes(true) && curr.includes(false)) setIndeterminate(true)
  ...
  return (
    <div id="cart" >
              ...
              cart.map((item, i) => {
                ...
                return <div className="cart-item" key={item.key}>
                  <div className='contents'>
                    ...
                    <div className="quantity"><InputNumber defaultValue={item.quantity} /></div>
      ...
      <div className="order-summary"  >
        ...
        <Link to='/checkout'><Button type='secondary' block >PROCEED TO CHECKOUT</Button></Link>
      </div>
    </div>
  )
}
