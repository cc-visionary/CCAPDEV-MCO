...
const Cart = ({ products, shippingFee, cart, setCart, ...props }) => {
  ...
  const totalCost = cart.reduce((sum, data) => sum + products[data.key - 1].price * data.quantity, 0);
