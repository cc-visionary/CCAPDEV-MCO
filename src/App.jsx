...
import ProductCatalog from './views/pages/buyer/ProductCatalog';
import ProductPage from './views/pages/buyer/ProductPage';
import Cart from './views/pages/buyer/Cart';
import Checkout from './views/pages/buyer/Checkout';
